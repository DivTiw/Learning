...
namespace Task_Tracker_Library.Repository
{
    public class UnitOfWork : IDisposable
    {
        ...
        public SchReportsRepository SchReportsRepo { get; }
        #endregion
        ...
        public UnitOfWork()
        {
            ...
            LoginRepo = new LoginRepository(_TTContext);
            ...
            #region Schedular Report Repository
            SchReportsRepo = new SchReportsRepository(_TTContext);
            #endregion
        }
