...
$(document).ready(function () {
    ...
    var cnt = $("#hid_module_cnt").val();
    //alert(cnt);
    if(cnt > 0)
    {
        $('#btn_saveWFLevels').prop('disabled', true);
        $('#btnSaveWorkflow').prop('disabled', true);
        $("tr.statuscheck td input").prop('disabled', true);   
     
    }
    else {
        $('#btn_saveWFLevels').prop('disabled', false);
        $('#btnSaveWorkflow').prop('disabled', false);
        $("tr.statuscheck td input").prop('disabled', false);
    }
});
